...
const WeatherCard = ({ icon, city, description, temp }) => {
  return (
    <div className='relative w-screen m-2 text-center md:px-36'>
      <div className='w-auto m-auto md:w-80 border border-gray-400 bg-gradient-to-b from-gray-50 via-gray-50 to-gray-300 flex flex-col justify-center items-center text-center p-6'>
